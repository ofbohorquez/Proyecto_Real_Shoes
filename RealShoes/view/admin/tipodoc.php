...
<head>
    ...
    <title>Registrar Tipo Documento | Lawyer Inc.</title>
</head>
<body>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-10">
            <form action="../../controller/admin/tipodoc/tipodoc_register.php" method="post" class="form-group">
                    ...
                    while($datos = mysqli_fetch_assoc($resultado)){
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>"; echo "<a href='../controller/admin/tipodoc/tipodoc_update?id=";echo $datos['tipodocid'];echo"'><i class='text-warning fa-solid fa-user-pen fa-2x'></i></a>"; echo " | "; echo "<a href='../controller/admin/tipodoc/tipodoc_delete.php?id=";echo $datos['tipodocid'];echo"'><i class='text-danger fa-solid fa-trash fa-2x'></i></a>";echo"</td>";                     
                                echo "
